    ...
    IClock clock) : IQueryHandler<ListOpsExceptionsQuery, OpsPagedResult<OpsExceptionItemDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var slice = all
            ...
            .Take(pageSize)
            .ToList();
        return new OpsPagedResult<OpsExceptionItemDto>(slice, all.Count, page, pageSize);
    }

    private async Task<List<OpsExceptionItemDto>> BuildAllAsync(CancellationToken cancellationToken)
    {
