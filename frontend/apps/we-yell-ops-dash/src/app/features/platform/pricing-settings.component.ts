...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, DatePipe, DecimalPipe, PercentPipe, RouterLink],
...
export class PricingSettingsComponent implements OnInit {
  ...
  // Estimate a sample quote with the current form so admins can see the
  // effect of their changes before saving.
