...
export const MOCK_ACCOUNTS: MockAccount[] = [
  ...
  /** WeYell customer portal — one mock account per journey stage (Mongo seeds match when useMock is off) */
  {
    id: 'acct_weyell_new_google',
    role: 'parent',
    ...
    parentId: 'parent_weyell_new_google',
  },
  {
    id: 'acct_weyell_ready_suite',
    role: 'parent',
    email: 'ready.suite@weyell.demo',
    password: 'demo1234',
    displayName: 'Nomsa Dube',
    phone: '+268 76 222 3344',
    createdAt: '2026-04-20T08:00:00Z',
    parentId: 'parent_weyell_ready_suite',
  },
  {
    id: 'acct_weyell_active',
    role: 'parent',
    email: 'active@weyell.demo',
    password: 'demo1234',
    displayName: 'Thabo Nkosi',
    phone: '+268 76 333 4455',
    createdAt: '2026-02-20T08:00:00Z',
    parentId: 'parent_weyell_active',
  },
  {
    id: 'acct_weyell_expiring',
    role: 'parent',
    email: 'expiring@weyell.demo',
    password: 'demo1234',
    displayName: 'Zanele Maseko',
    phone: '+268 76 444 5566',
    createdAt: '2026-01-20T08:00:00Z',
    parentId: 'parent_weyell_expiring',
  },
  {
  ...
  {
    id: 'acct_weyell_quote_done',
    role: 'parent',
    email: 'quote.done@weyell.demo',
    password: 'demo1234',
    displayName: 'Lungile Khumalo',
    phone: '+268 76 555 6677',
    createdAt: '2026-03-20T08:00:00Z',
    parentId: 'parent_weyell_quote_done',
  },
  {
    id: 'acct_weyell_inbox',
    role: 'parent',
    email: 'inbox@weyell.demo',
    password: 'demo1234',
    displayName: 'Musa Vilakati',
    phone: '+268 76 666 7788',
    createdAt: '2025-12-20T08:00:00Z',
    parentId: 'parent_weyell_inbox',
  },
];
